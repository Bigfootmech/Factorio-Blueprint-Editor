...
TestGridBoxWorks = {}
    ...
    function TestGridBoxWorks:testWorksOnSinglePositions()
        -- given
        local some_position = Position.new(1,2)
    ...
    function TestGridBoxWorks:testMultiplePositionsMustBeCorrectWayAround()
        -- given
        local some_position = Position.new(1,2)
        local other_position = Position.new(3,4)
        local bounding_box = Bounding_Box.new(other_position, some_position)
